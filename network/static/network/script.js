...
function build_post(post) {
    ...
    post_card.className = "card col col-6 other-tweet";

    const header = document.createElement('div');
    header.className = "card-header profile name-msg";
    ...
    likes_row.className = "row align-items-center your-reaction";
